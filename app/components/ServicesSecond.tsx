const ServicesSecond = () => {
	return (
		<div className="flex flex-col md:flex-row w-full justify-between m-auto xl:w-3/4 py-24 px-4 md:px-24 gap-8">
			<div className="flex flex-col justify-start gap-0 max-w-sm m-auto">
				<div className="font-bold -mb-10 text-4xl">за</div>
				<div className="font-bold -mb-10 mx-auto text-[250px] md:text-[500px]">
					3
				</div>
